...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Login data collected:', { email, password });
    navigate('/');
  };
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-4">
            ...
            >
              <span className="relative z-10 transition-colors duration-300 group-hover:text-black">Sign In</span>
        ...
        <div className="mt-8 text-center text-[11px] uppercase tracking-widest text-white/40">
          <p>Don't have an account? <Link to="/register" className="text-white hover:text-white/80 border-b border-white/20 pb-1 ml-2 transition-colors">Register</Link></p>
        </div>
      </motion.div>
    </div>
  );
